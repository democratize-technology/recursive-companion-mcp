...
DOMAIN_KEYWORDS: Dict[str, List[str]] = {
    "technical": ["code", "algorithm", "api", "debug", "performance", "architecture", "system", "database", "security",
                  "function", "python", "javascript", "tcp", "ip", "protocol", "optimize", "queries", "indexes", 
                  "rest", "authentication", "async", "await", "implement", "binary", "search", "stack", "software"],
    "marketing": ["marketing", "campaign", "audience", "brand", "conversion", "engagement", "market",
                  "customer", "segment", "targeting", "positioning", "messaging", "growth", "acquisition",
                  "social media", "ad", "copy", "facebook", "email", "launch", "compelling"],
    "strategy": ["goal", "objective", "plan", "roadmap", "vision", "competitive", "analysis", "swot",
                 "strategic", "long-term", "initiative", "milestone", "kpi", "metric"],
    "legal": ["contract", "compliance", "regulation", "liability", "agreement", "terms", "privacy", "gdpr",
              "legal", "law", "policy", "dispute", "intellectual property", "copyright", "trademark",
              "non-disclosure", "nda", "service", "saas"],
    "financial": ["revenue", "cost", "budget", "forecast", "investment", "profit", "cash flow", "valuation",
                  "financial", "accounting", "balance sheet", "income", "expense", "roi", "npv", "irr",
                  "calculate", "portfolio", "stock", "allocation", "statements"]
}
