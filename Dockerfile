...
RUN python -m venv /opt/venv && \
    ...
    /opt/venv/bin/pip install . && rm -rf /tmp/* /root/.cache/pip && \
...
# Re-declare runtime configuration arguments for this stage (Docker ARG scope is per-stage)
ARG MCP_HOST=127.0.0.1
ARG MCP_PORT=8087
ARG LOG_LEVEL=INFO
ARG RECURSIVE_COMPANION_RATE_LIMIT_PER_MINUTE=40
...
RUN groupadd -g ${USER_GID} ${USERNAME} && \
    ...
    # Ensure home directory is writable for configuration
